	...
	B: BtcNodeClient + 'a,
{
	fn context_key_count(
		...
		match secondary_currency {
			Currency::Btc | Currency::Bch | Currency::Ltc | Currency::Bsv | Currency::Dash | Currency::Zec | Currency::Doge => Ok(4),
	...
	fn create_context(
		...
		match secondary_currency {
			Currency::Btc | Currency::Bch | Currency::Ltc | Currency::Bsv | Currency::Dash | Currency::Zec | Currency::Doge => (),
			//_ => return Err(ErrorKind::UnexpectedCoinType),
		}
